                    ...
                    <form action="{{ $action }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-8 mb-3">
                                ...
                                <input type="text" class="form-control" name="description" id="description" aria-describedby="descriptionHelp" value="{{ old('description', $role->description ?? '') }}" required>
                            ...
                            <div class="col-sm-4  mb-3">
                                ...
                                <select class="form-select" name="status" id="status" aria-describedby="statusHelp" required>
                                    ...
                                    <option value="Ativo" {{ old('status', $role->status  ?? '') ==  'Ativo' ? 'selected' : ''}}>Ativo</option>
                                    <option value="Desativado" {{ old('status', $role->status  ?? '') ==  'Desativado' ? 'selected' : ''}}>Desativado</option>
                                </select>
